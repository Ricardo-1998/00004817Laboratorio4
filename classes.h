...
enum parameters {ELEMENT_LENGTH,T_NUEVA,K_CONSTANTE,EPSILONCAT,V_CONSTANTE,PHI,ALPHA,SIGMA,MEW};
...
public:
    void setParameters(float l,float t, float k, float epsiloncat,float v,float phi,float alpha,float sigma,float mew){
        parameters[ELEMENT_LENGTH]=l;
        parameters[T_NUEVA]=t;
        parameters[K_CONSTANTE]=k;
        parameters[EPSILONCAT]=epsiloncat;
        parameters[V_CONSTANTE]=v;
        parameters[PHI]=phi;
